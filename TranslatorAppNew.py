...
sourceText=st.text_area("Enter your text")
target_lang=st.selectbox("Select your language",list(languages.keys()))

if st.button("Translate"):
    if sourceText:
        translated_text=translator.translate(sourceText,dest=languages[target_lang])
